    ...
    <div class="grid grid-cols-12 gap-x-6">
                    ...
                    <div class="bg-theme-bodybg dark:bg-themedark-bodybg p-3 mt-4 rounded-lg">
                        <div class="mt-3 grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-5">
                                ...
                                <p class="text-primary-500 mb-0"><i class="ti ti-arrow-up-right"></i> 30.6%
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-theme-bodybg dark:bg-themedark-bodybg p-3 mt-4 rounded-lg">
                        <div class="mt-3 grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-5">
                                ...
                                <p class="text-warning-500 mb-0"><i class="ti ti-arrow-up-right"></i> 30.6%
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-theme-bodybg dark:bg-themedark-bodybg p-3 mt-4 rounded-lg">
                        <div class="mt-3 grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-5">
                                ...
                                <p class="text-success-500 mb-0"><i class="ti ti-arrow-up-right"></i> 30.6%
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-span-12 lg:col-span-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="grid mt-3">
                        <button class="btn btn-primary flex items-center justify-center gap-3"><i
        ...
        <div class="col-span-12 lg:col-span-9">
            <div class="card">
                <div class="card-body">
                    <div class="flex items-center justify-between">
                        <h5 class="mb-0">Buat Laporan Akhir</h5>
                        <div class="dropdown">
                            <a class="w-8 h-8 rounded-xl inline-flex items-center justify-center btn-link-secondary dropdown-toggle arrow-none"
                                href="#" data-pc-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="ti ti-dots text-lg leading-none"></i>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-3">
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-4 self-center">
                            <div class="grid">
                                <button class="btn btn-primary dflex align-center justify-center"><i
                                        class="ti ti-plus"></i>Isi Laporan Akhir</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <div
                            ...
                            <span class="avtar bg-theme-cardbg dark:bg-themedark-cardbg overflow-hidden">
                                <span
                                    class="flex items-center justify-center w-full h-full bg-primary-500/10 text-primary-500">+2</span>
                            </span>
                        </div>
                        <a href="#"
                            class="w-10 h-10 inline-flex items-center justify-center btn btn-primary rounded-full">
            ...
            <div class="card">
                <div class="card-body border-bottom pb-0">
                    ...
                    <ul
                        ...
                        <li class="group active">
                            <a href="javascript:void(0);" data-pc-toggle="tab" data-pc-target="tran-1"
                        ...
                        <li class="group">
                            <a href="javascript:void(0);" data-pc-toggle="tab" data-pc-target="tran-2"
                                class="inline-block mr-6 py-4 transition-all duration-300 ease-linear border-b-2 border-transparent group-[.active]:text-primary-500 group-[.active]:border-primary-500 hover:text-primary-500 active:text-primary-500">
                                Success
                            </a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-pc-toggle="tab" data-pc-target="tran-3"
                                class="inline-block mr-6 py-4 transition-all duration-300 ease-linear border-b-2 border-transparent group-[.active]:text-primary-500 group-[.active]:border-primary-500 hover:text-primary-500 active:text-primary-500">
                                Pending
                            </a>
                        </li>
                                    ...
                                    <div class="grow ltr:ml-3 rtl:mr-3">
                                        <div class="grid grid-cols-12 gap-2">
                                            ...
                                            <div class="col-span-6 ltr:text-right rtl:text-left">
                                                ...
                                                <p class="text-danger-500 mb-0"><i class="ti ti-arrow-down-left"></i>
                                                    10.6%</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="grow ltr:ml-3 rtl:mr-3">
                                        <div class="grid grid-cols-12 gap-2">
                                            ...
                                            <div class="col-span-6 ltr:text-right rtl:text-left">
                                                <h6 class="mb-1">+210,000</h6>
                                                <p class="text-success-500 mb-0"><i class="ti ti-arrow-up-right"></i>
                                                    10.6%</p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card-footer">
                    <div class="grid grid-cols-12 gap-2">
                        <div class="col-span-12 md:col-span-6">
                            <div class="grid">
                                <button class="btn btn-outline-secondary grid"><span class="truncate w-full">View all
                                        Transaction History</span></button>
                            </div>
                        </div>
                        <div class="col-span-12 md:col-span-6">
                            <div class="grid">
                                <button class="btn btn-primary grid"><span class="truncate w-full">Create
