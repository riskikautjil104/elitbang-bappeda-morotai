       ...
       <div class="col-12">
           ...
           <div class="card mb-6">
               ...
               <div class="card-body p-6">
                   <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-1 block">Judul Kegiatan</label>
                           <p class="text-base text-gray-800 font-medium">
                               {{ $laporan->judul_kegiatan }}
                           </p>
                       </div>
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-1 block">Jenis Kegiatan</label>
                       ...
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-1 block">OPD Pengusul</label>
                           <p class="text-base text-gray-800">{{ $laporan->user->name }}</p>
                       </div>
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-1 block">Penanggung Jawab</label>
                           <p class="text-base text-gray-800">{{ $laporan->penanggung_jawab }}</p>
                       </div>
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-1 block">Tahun Pelaksanaan</label>
                           <p class="text-base text-gray-800">{{ $laporan->tahun_pelaksanaan }}</p>
                       </div>
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-1 block">Lokasi Kegiatan</label>
                           <p class="text-base text-gray-800">{{ $laporan->lokasi_kegiatan }}</p>
                       </div>
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-1 block">Periode Pelaksanaan</label>
                       ...
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-1 block">Anggaran</label>
           ...
           <div class="card mb-6">
               ...
               <div class="card-body p-6">
                   <div class="space-y-6">
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-2 block">Latar Belakang</label>
                           <div class="prose max-w-none text-gray-700">
                               <p class="text-justify leading-relaxed">{{ $laporan->latar_belakang }}</p>
                           </div>
                       </div>
                       <div class="border-t border-gray-200 pt-6">
                           <label class="text-sm font-semibold text-gray-500 mb-2 block">Tujuan Kegiatan</label>
                           <div class="prose max-w-none text-gray-700">
                               <p class="text-justify leading-relaxed">{{ $laporan->tujuan_kegiatan }}</p>
                           </div>
                       </div>
                       <div class="border-t border-gray-200 pt-6">
                           <label class="text-sm font-semibold text-gray-500 mb-2 block">Metode Pelaksanaan</label>
                           <div class="prose max-w-none text-gray-700">
                               <p class="text-justify leading-relaxed">{{ $laporan->metode_pelaksanaan }}</p>
                           </div>
                       </div>
                       <div class="border-t border-gray-200 pt-6">
                           <label class="text-sm font-semibold text-gray-500 mb-2 block">Tahapan Pelaksanaan</label>
                           <div class="prose max-w-none text-gray-700">
           ...
           <div class="card mb-6">
               ...
               <div class="card-body p-6">
                   <div class="space-y-6">
                       <div>
                           <label class="text-sm font-semibold text-gray-500 mb-2 block">Output Kegiatan</label>
                           <div class="prose max-w-none text-gray-700">
                               <p class="text-justify leading-relaxed">{{ $laporan->output_kegiatan }}</p>
                           </div>
                       </div>
                       <div class="border-t border-gray-200 pt-6">
                           <label class="text-sm font-semibold text-gray-500 mb-2 block">Hasil Kegiatan</label>
                           <div class="prose max-w-none text-gray-700">
                               <p class="text-justify leading-relaxed">{{ $laporan->hasil_kegiatan }}</p>
                           </div>
                       </div>
                       <div class="border-t border-gray-200 pt-6">
                           <label class="text-sm font-semibold text-gray-500 mb-2 block">Persentase Realisasi</label>
                           <div class="flex items-center">
                               <div class="flex-1 bg-gray-200 rounded-full h-8 mr-4">
                       ...
                       @if ($laporan->kendala_pelaksanaan)
                           <div class="border-t border-gray-200 pt-6">
                               <label class="text-sm font-semibold text-gray-500 mb-2 block">Kendala Pelaksanaan</label>
                               <div class="prose max-w-none text-gray-700">
                       ...
                       @if ($laporan->solusi_kendala)
                           <div class="border-t border-gray-200 pt-6">
                               <label class="text-sm font-semibold text-gray-500 mb-2 block">Solusi Kendala</label>
                               <div class="prose max-w-none text-gray-700">
                       ...
                       @if ($laporan->file_laporan)
                           <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                               <div class="flex items-center">
                                   ...
                                   <div>
                                       <p class="font-semibold text-gray-800">Laporan PDF</p>
                               ...
                               <a href="{{ asset('storage/' . $laporan->file_laporan) }}" target="_blank" class="btn btn-sm btn-outline-primary rounded-lg">
                                   <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                       <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                   </svg>
                                   Download
                               </a>
                           </div>
                           ...
                           <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                               <div class="flex items-center justify-between mb-3">
                                   <div class="flex items-center">
                                       ...
                                       <div>
                                           <p class="font-semibold text-gray-800">Dokumentasi</p>
                           ...
                           <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                               <div class="flex items-center justify-between mb-3">
                                   <div class="flex items-center">
                                       ...
                                       <div>
                                           <p class="font-semibold text-gray-800">Data Pendukung</p>
                       ...
                       @if ($laporan->file_sk)
                           <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                               <div class="flex items-center">
                                   ...
                                   <div>
                                       <p class="font-semibold text-gray-800">Surat Keputusan</p>
                       ...
                       @if ($laporan->file_pemaparan)
                           <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                               <div class="flex items-center">
                                   ...
                                   <div>
                                       <p class="font-semibold text-gray-800">Presentasi/Pemaparan</p>
           ...
           <div class="card">
               ...
               <div class="card-body p-6">
                   <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                       <div>
                           <label class="text-gray-500 mb-1 block">Status Verifikasi</label>
                           <span class="badge
                       ...
                       <div>
                           <label class="text-gray-500 mb-1 block">Tanggal Verifikasi</label>
                       ...
                       <div>
                           <label class="text-gray-500 mb-1 block">Diverifikasi Oleh</label>
                           <p class="text-gray-800 font-medium">
