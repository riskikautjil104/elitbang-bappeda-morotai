<x-app>
    ...
    @if ($laporan->status == 'revisi' && $laporan->catatan_admin)
        <div class="alert alert-warning border-orange-500/20 bg-orange-500/10 mb-6" role="alert">
            <div class="flex items-start">
                ...
                <div class="text-sm">
                    <strong class="font-semibold">Catatan Revisi dari Admin:</strong>
                    <p class="mt-2">{{ $laporan->catatan_admin }}</p>
                </div>
            </div>
        </div>
    @endif
            ...
            <div class="card">
                <div class="card-header bg-primary-500/10 border-b border-primary-500/20">
                    <h5 class="text-lg font-semibold text-gray-800 dark:text-white mb-0">
                        Edit Laporan Akhir E-Litbang
                    </h5>
                </div>
                <div class="card-body p-8">
                    <form action="{{ route('apps.reports.update', Crypt::encrypt($laporan->id)) }}" method="POST"
                        ...
                        <div class="mb-10">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                        class="form-control h-12 text-base @error('judul_kegiatan') border-red-500 @enderror"
                                        id="judul_kegiatan" name="judul_kegiatan" placeholder="Masukkan judul kegiatan"
                                        value="{{ old('judul_kegiatan', $laporan->judul_kegiatan) }}" />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select h-12 text-base" id="jenis_kegiatan"
                                            ...
                                            <option value="penelitian"
                                                {{ old('jenis_kegiatan', $laporan->jenis_kegiatan) == 'penelitian' ? 'selected' : '' }}>
                                                Penelitian</option>
                                            <option value="inovasi"
                                                {{ old('jenis_kegiatan', $laporan->jenis_kegiatan) == 'inovasi' ? 'selected' : '' }}>
                                                Inovasi</option>
                                            <option value="pengembangan"
                                                {{ old('jenis_kegiatan', $laporan->jenis_kegiatan) == 'pengembangan' ? 'selected' : '' }}>
                                                Pengembangan</option>
                                            <option value="kegiatan_lainnya"
                                                {{ old('jenis_kegiatan', $laporan->jenis_kegiatan) == 'kegiatan_lainnya' ? 'selected' : '' }}>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="form-control h-12 text-base" id="opd_pengusul"
                                            value="{{ $laporan->user->name }}" readonly />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" class="form-control h-12 text-base" id="tahun_pelaksanaan"
                                            ...
                                            value="{{ old('tahun_pelaksanaan', $laporan->tahun_pelaksanaan) }}" />
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control h-12 text-base" id="lokasi_kegiatan"
                                        ...
                                        value="{{ old('lokasi_kegiatan', $laporan->lokasi_kegiatan) }}" />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" class="form-control h-12 text-base" id="tanggal_mulai"
                                            name="tanggal_mulai"
                                            value="{{ old('tanggal_mulai', $laporan->tanggal_mulai->format('Y-m-d')) }}" />
                                        @error('tanggal_mulai')
                                            <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control text-base" id="latar_belakang" name="latar_belakang" rows="5"
                                        placeholder="Jelaskan latar belakang kegiatan...">{{ old('latar_belakang', $laporan->latar_belakang) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control text-base" id="tujuan_kegiatan" name="tujuan_kegiatan" rows="4"
                                        placeholder="Jelaskan tujuan kegiatan...">{{ old('tujuan_kegiatan', $laporan->tujuan_kegiatan) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control text-base" id="metode_pelaksanaan" name="metode_pelaksanaan" rows="5"
                                        placeholder="Jelaskan metode yang digunakan dalam pelaksanaan kegiatan...">{{ old('metode_pelaksanaan', $laporan->metode_pelaksanaan) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control text-base" id="tahapan_pelaksanaan" name="tahapan_pelaksanaan" rows="6"
                                        placeholder="Jelaskan tahapan-tahapan pelaksanaan kegiatan secara rinci...">{{ old('tahapan_pelaksanaan', $laporan->tahapan_pelaksanaan) }}</textarea>
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control text-base" id="output_kegiatan" name="output_kegiatan" rows="4"
                                        placeholder="Jelaskan output/luaran yang dihasilkan dari kegiatan...">{{ old('output_kegiatan', $laporan->output_kegiatan) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control text-base" id="hasil_kegiatan" name="hasil_kegiatan" rows="5"
                                        placeholder="Jelaskan hasil kegiatan secara detail...">{{ old('hasil_kegiatan', $laporan->hasil_kegiatan) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" class="form-control h-12 text-base pr-12"
                                            ...
                                            min="0" max="100"
                                            value="{{ old('persentase_realisasi', $laporan->persentase_realisasi) }}" />
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control text-base" id="kendala_pelaksanaan" name="kendala_pelaksanaan" rows="4"
                                        placeholder="Jelaskan kendala yang dihadapi selama pelaksanaan kegiatan (jika ada)...">{{ old('kendala_pelaksanaan', $laporan->kendala_pelaksanaan) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control text-base" id="solusi_kendala" name="solusi_kendala" rows="4"
                                        placeholder="Jelaskan solusi yang diterapkan untuk mengatasi kendala (jika ada)...">{{ old('solusi_kendala', $laporan->solusi_kendala) }}</textarea>
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    @if ($laporan->file_laporan)
                                        <div class="mb-2 p-2 bg-gray-100 rounded text-sm">
                                            File saat ini: <a href="{{ asset('storage/' . $laporan->file_laporan) }}"
                                                target="_blank"
                                                class="text-blue-600">{{ basename($laporan->file_laporan) }}</a>
                                        </div>
                                    @endif
                                    <input type="file" class="form-control h-12 text-base" id="file_laporan_pdf"
                                        name="file_laporan" accept=".pdf" />
                                    <p class="text-xs text-gray-500 mt-1">Format: PDF, Maksimal 10MB. Kosongkan jika
                                ...
                                <div>
                                    ...
                                    @if (!empty($laporan->file_dokumentasi_array))
                                        <div class="mb-2 p-2 bg-gray-100 rounded text-sm">
                                            File saat ini: {{ count($laporan->file_dokumentasi_array) }} file
                                        </div>
                                    @endif
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, MP4, atau ZIP/RAR, Maksimal
                                        50MB. Upload baru akan mengganti file lama.</p>
                                ...
                                <div>
                                    ...
                                    @if (!empty($laporan->file_data_pendukung_array))
                                        <div class="mb-2 p-2 bg-gray-100 rounded text-sm">
                                            File saat ini: {{ count($laporan->file_data_pendukung_array) }} file
                                        </div>
                                    @endif
                                ...
                                <div>
                                    ...
                                    @if ($laporan->file_sk)
                                        <div class="mb-2 p-2 bg-gray-100 rounded text-sm">
                                            File saat ini: <a href="{{ asset('storage/' . $laporan->file_sk) }}"
                                                target="_blank"
                                                class="text-blue-600">{{ basename($laporan->file_sk) }}</a>
                                        </div>
                                    @endif
                                ...
                                <div>
                                    ...
                                    @if ($laporan->file_pemaparan)
                                        <div class="mb-2 p-2 bg-gray-100 rounded text-sm">
                                            File saat ini: <a
                                                href="{{ asset('storage/' . $laporan->file_pemaparan) }}"
                                                target="_blank"
                                                class="text-blue-600">{{ basename($laporan->file_pemaparan) }}</a>
                                        </div>
                                    @endif
                        ...
                        <div class="alert alert-primary border-primary-500/20 bg-primary-500/10 mb-8" role="alert">
                            <div class="flex items-start">
                                ...
                                <div class="text-sm">
                                    <strong class="font-semibold">Perhatian:</strong> Pastikan semua data yang diisi
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Intercept form submission untuk debug
            form.addEventListener('submit', function(e) {
                console.log('Form is submitting...');
                console.log('Form action:', form.action);
                console.log('Form method:', form.method);

                // Check if any file inputs are empty
                const fileInputs = form.querySelectorAll('input[type="file"]');
                fileInputs.forEach(input => {
                    console.log(`${input.name}:`, input.files.length > 0 ? 'Has files' : 'Empty');
                });

                // Uncomment baris di bawah untuk mencegah submit dan lihat console
                // e.preventDefault();
                // return false;
            });
